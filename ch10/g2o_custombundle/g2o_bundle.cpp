...
void SetLinearSolver(std::unique_ptr<BalBlockSolver> &solver_ptr, const BundleParams &params)
{
    ...
    else if (params.linear_solver == "sparse_schur")
    {
        ...
        //linearSolver.reset(new g2o::LinearSolverCholmod<BalBlockSolver::PoseMatrixType>());
        //linearSolver = g2o::make_unique<LinearSolverCholmod<BalBlockSolver::PoseMatrixType>>();
    ...
    //solver_ptr.reset(linearSolver.release());
